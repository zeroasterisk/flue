...
- [`client.agents`](/docs/sdk/agents/) invokes persistent agent instances over HTTP or WebSockets.
- [`client.workflows`](/docs/sdk/workflows/) starts workflow invocations over WebSockets.
...
- [Errors](/docs/sdk/errors/) describes HTTP, WebSocket, and stream errors.
- [WebSocket protocol](/docs/sdk/websockets/) describes socket configuration and low-level protocol types.
