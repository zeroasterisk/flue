...
```ts title="src/channels/salesforce-marketing-cloud.ts"
import {
...
```ts title="src/salesforce-marketing-cloud-client.ts"
...
See the
[`@flue/salesforce-marketing-cloud` API reference](/docs/api/salesforce-marketing-cloud-channel/).
